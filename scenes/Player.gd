...
func _ready():
	...
	if active:
		activate()
	_add_planet(load('res://scenes/planet.png'), -60, -25, 50, 0)
	_add_planet(load('res://scenes/blue_moon.png'), -80, 10, 1, 0)
	_add_planet(load('res://scenes/gray_moon.png'), -85, -10, 0.9, 0)
